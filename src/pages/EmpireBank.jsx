...
// ---------- Constants ----------
// IMPORTANT: prefer the Worker URL (same logic as your working file)
const API_BASE = (
      ...
      <div className="relative max-w-6xl mx-auto p-6">
        ...
        <header className={`${GLASS} ${SOFT} p-4 md:p-5 flex items-center justify-between gap-4`}>
          <div>
            ...
            <p className="opacity-80 text-sm md:text-base">Your in-game balances & withdrawals.</p>
          </div>
          ...
          <div className={`${GLASS} ${SOFT} relative w-full max-w-lg p-5`}>
            ...
            <form className="mt-4 space-y-3" onSubmit={submitWithdrawal}>
              <div>
                ...
                <select className={INPUT} value={form.token} onChange={e => setForm(f => ({ ...f, token: e.target.value }))}>
              ...
              <div>
                ...
                <input className={INPUT} type="text" placeholder="0x..." value={form.to} onChange={e => setForm(f => ({ ...f, to: e.target.value }))} />
              ...
              <div className="pt-2 flex items-center justify-end gap-2">
                ...
                <button type="submit" className={BTN_PRIMARY} disabled={busy}>{busy ? "Sending…" : "Withdraw"}</button>
              </div>
            </form>
          </div>
        </div>
